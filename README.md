This repository provides a guide on how to build the Skia graphics library (version M116+ to M145+) with minimal resource usage. Specifically, it demonstrates how to achieve the build using only around 80MB of download and 300MB of disk space.
